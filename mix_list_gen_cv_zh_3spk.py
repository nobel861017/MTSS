        ...
        for i in range(args.k):
            for j in range(args.k):
                    for k in range(args.k):
                        ...
                        string = ' '.join([speaker_wav_dict[spk1][i], str(db), speaker_wav_dict[spk2][j], str(-db), speaker_wav_dict[spk3][k], '0'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='/home/gerber531/Desktop/Data/common-voice-zh-split-4s/')
    ...
    parser.add_argument('--spknum', type=int, default=15, help='number of speakers to use')
    ...
    for split_dir in split_dirs:
        ...
        for d in split_dir:
            ...
            if d == 'train/':
                gen_mix_list(args, speaker_utt_dict, 'mix_3_spk_tr.txt')
            elif d == 'dev/':
                gen_mix_list(args, speaker_utt_dict, 'mix_3_spk_cv.txt')
            elif d == 'test/':
                gen_mix_list(args, speaker_utt_dict, 'mix_3_spk_tt.txt')

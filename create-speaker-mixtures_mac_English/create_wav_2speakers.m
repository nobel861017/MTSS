...
data_type = {'tr', 'cv', 'tt'};
wsj0root = '/path/to/the/dir/containing/multi_accent_split_4s'; % YOUR_PATH/, the folder containing multi_accent_split_4s
output_dir8k='/path/to/mac-meta-mix-split-4s-English/2speakers/wav8k';
